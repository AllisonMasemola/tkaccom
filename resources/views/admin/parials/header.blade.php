...
<html class="light" lang="en"><head>
    ...
    {{-- Required for Blade x-dropdown (Alpine.js) behavior --}}
...
<div class="flex min-h-screen">
    ...
    <aside class="hidden md:flex flex-col h-screen w-64 border-r-0 bg-[#f3f3f3] dark:bg-slate-900 py-6 sticky top-0">
        <div class="px-6 mb-10">
            <h1 class="text-xl font-bold text-[#00008B] dark:text-white tracking-tighter">TK Cape Accomommodation</h1>
            <p class="text-xs text-slate-500 font-label">Admin Dashboard</p>
        </div>
        @php
          $activeClass   = 'text-slate-600 dark:text-slate-400 hover:text-[#4951c3] mx-2 px-4 py-3 transition-colors flex items-center gap-3 font-manrope text-sm font-semibold tracking-tight';
        ...
        <nav class="flex-1 space-y-1">
            ...
            <a class="{{ request()->routeIs('admin.accommodation.*') ? $activeClass : $inactiveClass }}" href="{{ route('admin.accommodation.index') }}">
                <span class="material-symbols-outlined">bed</span>
                Accommodations
            </a>
            <a class="{{ request()->routeIs('admin.prestige.*') ? $activeClass : $inactiveClass }}" href="{{ route('admin.prestige.index') }}">
                <span class="material-symbols-outlined">auto_awesome</span>
                Prestige Movement
            </a>
            <a class="{{ request()->routeIs('admin.events.*') ? $activeClass : $inactiveClass }}" href="#">
        ...
        <div class="mt-auto pt-6 border-t border-[#eeeeee] dark:border-slate-800 space-y-1">
            <a class="{{ request()->routeIs('admin.settings.*') ? $activeClass : $inactiveClass }}" href="#">
                <span class="material-symbols-outlined">settings</span>
                Settings
            </a>
            <a class="{{ request()->routeIs('admin.support.*') ? $activeClass : $inactiveClass }}" href="#">
