        ...
        <div class="surface-container-lowest glass-panel shadow-[0_20px_40px_rgba(26,28,28,0.05)] rounded-sm p-8 md:p-12 transition-all duration-500">
            ...
            <form action="#" class="space-y-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <input class="w-full bg-transparent border-0 border-b border-outline-variant/30 focus:ring-0 focus:border-secondary transition-colors py-3 px-0 font-body placeholder:text-outline/50" id="email" name="email" placeholder="your@email.com" type="email"/>
                </div>
                <!-- Password Field -->
                <div class="space-y-1.5">
