...
class AdminEmailsController extends Controller
{
    ...
    {
        // Fetch only bookings where an email was dispatched.
        // Eager-load bookable to avoid N+1 in the view if you ever show property name.
        $emails = Booking::with('bookable')
            ->whereNotNull('email_notification')
            ->latest()
            ->paginate(20);
